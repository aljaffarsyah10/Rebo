        ...
        <div className='flex w-full max-w-lg flex-col items-center justify-center space-y-10'>
          ...
          <div className='space-y-4 text-center'>
            <div className='relative'>
              ...
              <div className='absolute -bottom-1 left-1/2 h-1 w-24 -translate-x-1/2 rounded-full bg-gradient-to-r from-[#fb8500] to-[#ffb703]'></div>
            </div>
          ...
          {/* ClerkSignInForm without container */}
